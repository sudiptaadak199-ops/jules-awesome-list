...
var Config = {
  ...
  SHEETS_DEFINITION: {
    "Dashboard": {
      gridlines: false,
      columnsWidths: [45, 130, 140, 110, 110, 110, 120, 120, 140, 100, 100, 160, 95, 110, 120, 150, 100]
    },
    "Settings": {
      gridlines: true,
    ...
    "Stock Master": {
      ...
      defaultRows: [
        ...
        ["ONGC", "Oil & Natural Gas Corp.", "NSE", "Energy", "Oil & Gas", "Active", "", "2024-01-01"],
        ...
        ["HDFCBANK", "HDFC Bank Ltd.", "NSE", "Banking", "Financial Services", "Active", "", "2024-01-01"],
        ["ICICIBANK", "ICICI Bank Ltd.", "NSE", "Banking", "Financial Services", "Active", "", "2024-01-01"],
        ["TATAMOTORS", "Tata Motors Ltd.", "NSE", "Auto", "Automotive", "Active", "", "2024-01-01"],
        ["MARUTI", "Maruti Suzuki India Ltd.", "NSE", "Auto", "Automotive", "Active", "", "2024-01-01"],
        ["SUNPHARMA", "Sun Pharmaceutical Industries", "NSE", "Pharma", "Pharmaceuticals", "Active", "", "2024-01-01"],
        ["CIPLA", "Cipla Ltd.", "NSE", "Pharma", "Pharmaceuticals", "Active", "", "2024-01-01"],
        ["ITC", "ITC Ltd.", "NSE", "FMCG", "Consumer Goods", "Active", "", "2024-01-01"],
        ["HINDUNILVR", "Hindustan Unilever Ltd.", "NSE", "FMCG", "Consumer Goods", "Active", "", "2024-01-01"],
        ["TATASTEEL", "Tata Steel Ltd.", "NSE", "Metal", "Metals & Mining", "Active", "", "2024-01-01"],
        ["JSWSTEEL", "JSW Steel Ltd.", "NSE", "Metal", "Metals & Mining", "Active", "", "2024-01-01"],
        ["DLF", "DLF Ltd.", "NSE", "Realty", "Real Estate", "Active", "", "2024-01-01"],
        ["GODREJPROP", "Godrej Properties Ltd.", "NSE", "Realty", "Real Estate", "Active", "", "2024-01-01"]
      ]
    },
    "Historical Data": {
      gridlines: true,
    ...
    "Rotation History": {
      gridlines: true,
      frozenRows: 1,
      columnsWidths: [100, 120, 140, 110, 110, 100, 140, 100, 100, 130, 90, 180, 110, 110, 110],
      headers: [
